...
import {JwtPayload, SignInRequestBody, SignInResponseBody, SignUpRequestBody, SignUpResponseBody} from "./auth.type";
...
export const signUp = async (
    req: Request<{}, SignUpResponseBody, SignUpRequestBody>,
    res: Response
) => {
    try {
...
export const signIn = async (
    req: Request<{}, SignInResponseBody, SignInRequestBody>,
    res: Response
) => {
    try {
