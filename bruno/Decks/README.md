...
Un deck est une collection de 20 cartes appartenant à un utilisateur. Les decks sont utilisés pour jouer des parties.
...
```json
{
  ...
  "cards": ["001", "004", "007", ...] // 20 IDs de cartes
}
```
...
```json
{
  ...
  "cards": ["006", "009", "012", ...] // 20 IDs de cartes
}
```

**Notes** :
- Si `cards` est fourni, il doit contenir exactement 20 IDs valides
