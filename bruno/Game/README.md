...
**Socket.io** utilise un protocole spécial au-dessus de WebSocket. Bruno supporte les WebSockets avec le type `ws`, mais
Socket.io a son propre format de messages.
